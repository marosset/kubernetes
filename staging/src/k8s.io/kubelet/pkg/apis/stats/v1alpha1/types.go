...
const (
	...
	// SystemContainerPhysicalMemory is the container name for the system container tracking global memory usage (only used on Windows).
	SystemContainerWindowsGloballMemory = "windows-global-memory"
)
